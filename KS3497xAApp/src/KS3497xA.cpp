...
KS3497xA::KS3497xA(const char *portName, int nChannels, int maxBuffers, int maxMemory)
...
KS3497xA::readInt32(asynUser *pasynUser, epicsInt32 *value)
{
    asynStatus status = asynSuccess;
    return status;
}

KS3497xA::writeInt32(asynUser *pasynUser, epicsInt32 value)
{
    asynStatus status = asynSuccess;
    return status;
}

KS3497xA::readFloat64(asynUser *pasynUser, epicsFloat64 *value)
{
    asynStatus status = asynSuccess;
    return status;
}

KS3497xA::writeFloat64(asynUser *pasynUser, epicsFloat64 value)
{
    asynStatus status = asynSuccess;
    return status;
}

KS3497xA::writeOctet(asynUser *pasynUser, const char *value, size_t maxChars, size_t *nActual)
{
    asynStatus status = asynSuccess;
    return status;
}
